...
############################################
convert_matrix_to_propper_transition <- 
...
MicroSim <- function(v_M_1, n_i, n_t, v_n, d_c, d_e, TR_out = TRUE, 
  ...
  for (t in 1:n_t) {
    ...
    my_age_prob_matrix <- 
      convert_matrix_to_propper_transition(my_age_prob_matrix = my_age_prob_matrix, 
...
new_cases_2 <- function(state1, state2){
  # this function recieives two strings with the names of a state as named in the 
