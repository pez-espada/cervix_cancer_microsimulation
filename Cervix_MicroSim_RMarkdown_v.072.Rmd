...
-   Build everything from scrrratch
  ...
  seeds <- sample(1:10000, numb_of_sims, replace = FALSE)  # Generate random seeds
  {
    ...
    for(sim in 1:numb_of_sims) {
      ...
      for (t in 1:(n_t)) {
        ...
        # As we have performed the diagnose/screening BEFORE the state TRANSITION
        # in the program for the current time/cycle, and the transition function
        # (samplev()) modifies states at time + 1 we need to make sure that the
        # possible change we have made in the screening and survival prevails:
