...
output_file <-
  ...
  paste0("data/last_results_20250324/stacked_sims_20x10E6x75_vacc2_0.0_20250414_sim_", slurm_job_id, ".rds")
...
sim_result_80 <- 
  readRDS(file = "data/last_results_20250324/stacked_sims_20x10E6x75_vacc2_0.8_20250413_sim_19884.rds")
