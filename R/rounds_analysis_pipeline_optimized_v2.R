#===============================================================================
# rounds_analysis_pipeline_optimized_v2.R
...
# ---------------- Pipeline ----------------
analyze_rounds_optimized_v2 <- function(sim_result, sample_for_plot = 5000, n_cores = 4) {
  ...
  }, .options = furrr_options(seed = TRUE, globals = c("format_rounds", "sample_for_plot")))
...
# sim_analysis <- analyze_rounds_optimized_v2(sim_result, sample_for_plot = 5000, n_cores = 4)
