...
#    new_result[[Strategy_name]][[name_level_of_sim]] <- as.data.frame(result[[Strategy_name]][[name_level_of_sim]])
#    
#    # Remove redundant "sim.1" column if it exists
#    if ("sim.1" %in% colnames(new_result[[Strategy_name]][[name_level_of_sim]])) {
#      new_result[[Strategy_name]][[name_level_of_sim]] <- new_result[[Strategy_name]][[name_level_of_sim]][, !colnames(new_result[[Strategy_name]][[name_level_of_sim]]) %in% "sim.1"]
#    }
#  }
#  
#  return(new_result)
